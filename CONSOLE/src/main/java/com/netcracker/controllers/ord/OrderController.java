...
public class OrderController {
 ...
 @PostMapping(value = "/person/new-order", consumes = MediaType.APPLICATION_JSON_VALUE, produces =
 ...
 @PutMapping(value = "/person/close-order", consumes = MediaType.APPLICATION_JSON_VALUE, produces =
  MediaType.APPLICATION_JSON_VALUE)
 ...
 @PutMapping(value = "/details/update-order", consumes = MediaType.APPLICATION_JSON_VALUE, produces =
  MediaType.APPLICATION_JSON_VALUE)
 ...
 @ApiOperation("Order update")
 @GetMapping(value = "/details/order", consumes = MediaType.APPLICATION_JSON_VALUE, produces =
  MediaType.APPLICATION_JSON_VALUE)
 public ResponseEntity<List<OrderDto>> getOrderById(@RequestParam UUID uuid,
                                                    @ApiIgnore Principal principal)
  throws SaveSearchErrorException {
  return ResponseEntity.ok(orderServices.getAllOrderById(principal.getName(), uuid));
 }
